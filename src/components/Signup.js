...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(formData.email, formData.password, formData.username, formData.confirmPassword)
    ...
    try {
      ...
      if (json.success) {
        ...
        // props.showAlert(json.message || "Sign up unsuccessful!", "danger");
        ...
        <div style={{ padding: "30px" }}>
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex align-items-center my-3 Login-or">
              ...
              <span className="px-2 text-muted">Already have an account?</span>
              <hr className="flex-grow-1" />
            </div>
